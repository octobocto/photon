    ...
    RpcClient: ClientT + Sync,
{
    Ok(match command {
        ...
        Command::OpenApiSchema => {
            ...
            let mut schema = photon_app_rpc_api::open_api::RpcDoc::openapi();
            schema.merge(photon_app_rpc_api::node::PrivateRpcDoc::openapi());
            schema.merge(photon_app_rpc_api::node::RpcDoc::openapi());
            schema.merge(photon_app_rpc_api::wallet::RpcDoc::openapi());
